package com.atguigu.crud.tencent.util;
...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wx124d3fe4ec01f817";//微信开发平台应用id
	public static String APP_SECRET = "f92a325e742ec50af8a1b1db8fefae7d";//应用对应的凭证
	//应用对应的密钥
	...
	public static String PARTNER = "1470162702";//财付通商户号
	public static String PARTNER_KEY = "W3VhH97BRKdZojhZNF1ecZhTzbZxAyFB";//商户号对应的密钥
